...
```bash
python train/sft_module.py --module hypothesizer --config modules/hypothesizer/config.yaml
```

## Pesos finais

Quando publicado: `iterate-labs/caracal-1-hypothesizer-lora` no HuggingFace Hub.
